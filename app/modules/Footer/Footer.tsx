...
const Footer: React.FC = () => {
  ...
  const links = useMemo(
    () => [
      ...
      // { to: '/privacy', label: t('header.link7') }, // Прибрано політику конфіденційності
    ],
    [],
  )
  ...
  return (
    <div className={style.bg} id="contacts" suppressHydrationWarning>
      <div className={`customContainer ${style.wrap}`} suppressHydrationWarning>
        <Image
          ...
          loading="lazy"
        />
        <nav className={style.wrap_links} suppressHydrationWarning>
          {links.map(({ to, label }) => (
...
const AddressSection: React.FC = () => {
  // const { t } = useStaticTranslations()
  return (
    <div className={style.wrap_address} suppressHydrationWarning>
      <div className={style.wrap_address__item} suppressHydrationWarning>
        <a
          target={'_blank'}
...
const OffertaSection: React.FC<{ date: number }> = ({}) => {
  // const { t } = useStaticTranslations()
  return (
    <div className={style.wrap_offerta} suppressHydrationWarning>
...
const ScrollToTop: React.FC = () => {
  // const { t } = useStaticTranslations()
  return (
    <Link to="header" smooth duration={500} className={style.wrap_scroll} suppressHydrationWarning>
      <div className={style.wrap_scroll__txt} suppressHydrationWarning>Нагору</div>
      <svg
